...
%Our starting point is the re-examination of the (basic) SFM.
%\textcolor{red}{We propose a reduce-in-units equation of motion of 
...
%the collective motion in dense crowds.
