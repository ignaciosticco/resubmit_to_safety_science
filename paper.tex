...
for crowd dynamics have been developed. The first model was developed by Hirai 
...
\textcolor{red}{More recent measures of the fundamental diagram in an extreme density
 situation show that, in some situations, the flux may increase with the density (Ref.~\cite{lohner1}). 
This seems to contradict the results of Ref.~\cite{helbing3}. Nevertheless, the measurements of Ref.~\cite{lohner1}
were taken in the Kabba while the measurements of Ref.~\cite{helbing3} were taken at the entrance of
the Jamaraat bridge. As stated in Ref~\cite{lohner1}, the fundamental diagram may depend
strongly on the type of motion and on the nature of the event. Pedestrians in the Kaaba
may walk differently than pedestrians entering to the Jamarat bridge 
(due to differences according to the moment of the ritual).}\\
...
Lohner et al. Ref.~\cite{lohner2}. Recently a paper was published that uses 
...
starting point is the re-examination of the (basic) SFM.
\textcolor{red}{We proposed to reduce in units the equation of motion of 
the SFM (Eq.~\ref{eqn_appendix_1} and Eq.~\ref{eqn_appendix_2}). This leads us
to two control parameters} $\mathcal{A}$ and $\mathcal{K}$ (see Section~\ref{appendix_1}) that may handle
...
\textcolor{red}{In other words, the bimodal distribution occurs because when 
the giant component is formed there are some small clusters ``caged"
inside the giant component. These small clusters do not touch any 
pedestrian of the giant component.} \\
...
\bibitem{Togashi1}
\textcolor{red}{Togashi, F., Misaka, T., L\"ohner, R., \& Obayashi, S. (2018). 
