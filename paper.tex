...
to two control parameters} $\mathcal{A}$ and $\mathcal{K}$ (see Section~\ref{appendix_1}) may handle
...
\bibitem{Baqui1}
\textcolor{red}{Baqui, Muhammad, and Rainald Löhner. "Real-time crowd safety
...
\bibitem{Togashi1}
\textcolor{red}{Togashi, Fumiya, et al. "Using ensemble Kalman filter to
determine parameters for computational crowd dynamics simulations." 
Engineering Computations 35.7 (2018): 2612-2628.}

\bibitem{lohner2}
\textcolor{red}{L\"ohner, Rainald. "On the modeling of pedestrian motion." 
